...
--	11. Encuentra el tìtulo de peliculas que no sean NC-17 ni G en clasificación
...
/*	13. Encuentra el título de todas las películas que tengan una duración
		mayor a 180 minutos  */
...
/* 	16. Encuentra el nombre y apellido de los actores que aparecen
...
/*	18. Encuentra el título de las películas que son comedias
...
/*	19. Encuentra las categorías de películas que tienen un promedio de duración
...
--	20. ¿Cuál es el promedio de duración del alquiler de las películas?
...
-- 22. Números de alquiler por día ordenados por cantidad de alquiler DESC
...
--	23. Encuentra las películas con una duracion superior al promedio
...
--	24. Averigua el numero de alquileres registrados por mes
...
--	25. Encuentra el promedio, la desviacion estandar y varianza del total pagado
...
--	27. Muestra el id de los actores que hayan participado en mas de 40 peliculas
...
/* 	28. Obtener todas las películas y, si están disponibles en el inventario,
...
--	29. Obtener los actores y el número de peliculas en las que han actuado
...
/*	31. Obrener todos los actores y mostrar las películas en las que han actuado,
...
--	33. Encuentra los 5 clientes que mas dinero se hayan gastado con nosotros
...
--	36. Encuentra el id del actor mas bajo y del actor mas alto en la tabla actor
...
--	39. Selecciona las 5 primeras películas de la tabla "film"
...
/*	40. Agrupa los actores por su nombre y cuenta cuántos actores tienen el mismo
...
/*	42. Muestra todos los clientes y sus alquileres si existen,
...
/*	43. Realiza un CROSS JOIN entre las tablas "film" y "category"
...
--	44. Encuentra los actores que han participado en películas de la categoria 'Action'
...
--	46. Selecciona el nombre de los actores con el número de películas en las que han participado
...
/*	47. Crea una vista llamada "actor_num_peliculas" que muestre los nomres de los actores 
...
___________________________________________________________________________
/*	50. Crea una tabla temporal llamada “cliente_rentas_temporal” para
...
/*	51. Crea una tabla temporal llamada "peliculas_alquiladas" que almacene 
...
___________________________________________________________________________
/*	52. Encuentra el título de las películas que han sido alquiladas por el cliente
...
ORDER BY f.title;
___________________________________________________________________________
/* 	53. Encuentra los nombres de los actores que han actuado en al menos una
